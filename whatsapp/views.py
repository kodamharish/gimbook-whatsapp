...
def send_message(phone_number, template, media_id=None, media_type=None, variables=None):
    url = "https://graph.facebook.com/v21.0/527796540420714/messages"
    headers = {
        "Authorization": "Bearer EAAIgN96TlgQBO0dZBgOh5WNR494Ayy9vbl7DGByxO9dwewnpBruLGQZASj9AyMnbFS5VfX7L9ELE5mCKqOMPWJEFq2rSMrKQSSZAZC56bzw9AupAcOTQ9ZCxNWhWBXE4Qx5S0qcX1Sbb3SEDrbYrakpjrmQEEmfV4XjRoAi93k84opfV2C64D0kYYzJgLebWN1AZDZD",
...
def Media_Id_Generator(media_file):
    url = "https://graph.facebook.com/v21.0/527796540420714/media"
    headers = {
        "Authorization": "Bearer EAAIgN96TlgQBO0dZBgOh5WNR494Ayy9vbl7DGByxO9dwewnpBruLGQZASj9AyMnbFS5VfX7L9ELE5mCKqOMPWJEFq2rSMrKQSSZAZC56bzw9AupAcOTQ9ZCxNWhWBXE4Qx5S0qcX1Sbb3SEDrbYrakpjrmQEEmfV4XjRoAi93k84opfV2C64D0kYYzJgLebWN1AZDZD"
    }
    files = {
